...
import config
from ArnavX import Carbon, YouTube, app
from ArnavX.core.call import Arnav
from ArnavX.misc import db
from ArnavX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from ArnavX.utils.exceptions import AssistantErr
from ArnavX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from ArnavX.utils.inline.playlist import close_markup
from ArnavX.utils.pastebin import Arnavbin
from ArnavX.utils.stream.queue import put_queue, put_queue_index
from ArnavX.utils.thumbnails import gen_thumb, gen_thumbb
...
async def stream(
    ...
    if forceplay:
        await Arnav.force_stop_stream(chat_id)
