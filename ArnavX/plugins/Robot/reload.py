...
from ArnavX.utils.database import get_authuser_names, get_cmode
from ArnavX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Arnav.stop_stream(message.chat.id)
    except:
        pass
